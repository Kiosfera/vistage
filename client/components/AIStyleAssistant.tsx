...
const initialMessage: Message = {
  id: "1",
  content:
    "Olá! Eu sou a Luna, sua assistente de estilo pessoal com IA! 💫 Baseando-me na sua análise facial e preferências, posso te ajudar a criar looks incríveis. O que você gostaria de saber hoje?",
  sender: "ai",
  timestamp: new Date(),
  suggestions: [
