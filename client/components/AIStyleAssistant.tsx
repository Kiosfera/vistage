...
const initialMessage: Message = {
  id: '1',
  content: 'Olá! Eu sou a Luna, sua assistente de estilo pessoal com IA! 💫 Analisei seu perfil e estou aqui para te ajudar a descobrir seu potencial de estilo. Com base na sua análise facial e preferências, vou te dar dicas personalizadas que vão realçar sua beleza natural. O que você gostaria de explorar primeiro?',
  sender: 'ai',
  timestamp: new Date(),
  suggestions: [
